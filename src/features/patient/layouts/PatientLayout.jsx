...
const links = [
    ...
    { to: "/patient/rendezvous", label: "Rendez-vous" },
    { to: "/patient/dossier-medical", label: "Dossier médical" },
    { to: "/patient/consultations", label: "Consultations" },
    { to: "/patient/ordonnances", label: "Ordonnances" },
    { to: "/patient/profile", label: "Profile" },
    { to: "/patient/statistics", label: "Statistics" },
];
                ...
                <div className="flex h-full flex-col justify-between">
                    <div className="space-y-6 overflow-y-auto pr-1">
                        <div className="mb-8 rounded-2xl bg-white/90 p-5 shadow-sm">
                            ...
                            <p className="mt-2 text-sm text-slate-600">Mon suivi médical personnel.</p>
                        </div>
                ...
                <header className="border-b border-slate-200 bg-white/90 px-6 py-4 backdrop-blur-xl shadow-sm">
                    <div className="mx-auto flex max-w-7xl flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div>
                            ...
                            <h1 className="text-xl font-semibold text-slate-900">Portail patient</h1>
                        </div>
