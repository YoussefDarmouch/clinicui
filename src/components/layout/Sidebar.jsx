...
export default function Sidebar() {
    ...
    return (
        <aside className="flex min-h-screen w-72 flex-col justify-between bg-gradient-to-b from-slate-900 via-slate-950 to-slate-900 px-6 py-8 text-slate-300 shadow-[0_24px_80px_-32px_rgba(15,23,42,0.8)]">
            <div>
