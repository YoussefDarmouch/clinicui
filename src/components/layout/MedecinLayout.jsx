...
const links = [
    ...
    { to: '/medecin/rendezvous', label: 'Rendez-vous' },
    { to: '/medecin/ordonnances', label: 'Ordonnances' },
    { to: '/medecin/statistics', label: 'Statistiques' },
    { to: '/medecin/profile', label: 'Profil' },
]
                    ...
                    <div className="space-y-6 overflow-y-auto pr-1">
                        <div className="mb-8 rounded-2xl bg-white/90 p-5 shadow-sm">
                            ...
                            <p className="mt-2 text-sm text-slate-600">
                                Navigation rapide pour le suivi clinique.
                            </p>
                        </div>
                ...
                <header className="border-b border-slate-200 bg-white/90 px-6 py-4 backdrop-blur-xl shadow-sm">
                    <div className="mx-auto flex flex-col gap-4 md:flex-row md:items-center md:justify-between max-w-7xl">
                        <div>
                            ...
                            <h1 className="text-xl font-semibold text-slate-900">Suivi médical</h1>
                        </div>
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <Link to="/medecin/dashboard" className="inline-flex items-center rounded-full bg-primary-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-primary-700">
                                Dashboard
                            </Link>
                        </div>
                    </div>
